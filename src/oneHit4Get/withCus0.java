...
public class withCus0 {

    // 닉네임을 사용자에 맞게 변경해 주세요.
    static final String NICKNAME = "힘조절";
...
//                     continue;
                ...
                if (!hitList.isEmpty()) {
                    power = (float) Math.max(40f,(hitList.get(0).power+1.27)*1.4f/6.62f);
//               power = 40f;
//               power = (float) (hitList.get(0).power+1.27)*1.6f/6.62f;
                    ...
                    power = 80f;
//               power = (float) (hitListWithCu.get(0).power+1.27)*1.4f/6.62f;
